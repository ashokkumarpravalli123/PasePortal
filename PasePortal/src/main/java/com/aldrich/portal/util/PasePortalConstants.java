package com.aldrich.portal.util;

import java.util.Date;

public interface PasePortalConstants 
{
	...
	public static final String OPENCALSIS_CUSTOMERS_FILE_PATH = "D:\\customers.txt";
	...
	public static final long TIME_INTERVAL_BETWEEN_REQUESTS = 20000;
	...
	//FTP Server Details
		public static final String SFTP_HOST="secure.woundtech.net";
		public static final Integer SFTP_PORT=22;
		public static final String SFTP_USERNAME="sputtala@woundtech.net";
		public static final String SFTP_PASSWORD="Welcom3_dat4";
		public static final String SFTP_SFTPWORKINGDIR="/Net Health Systems/";
